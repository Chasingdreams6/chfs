...
int extent_server::create(uint32_t type, extent_protocol::extentid_t &id, unsigned long long tid)
{
...
int extent_server::put(extent_protocol::extentid_t id, std::string buf, int &, unsigned long long tid)
{
  id &= 0x7fffffff;
...
int extent_server::get(extent_protocol::extentid_t id, std::string &buf, unsigned long long tid)
{
  if (EXTENT_DEBUG)
...
int extent_server::getattr(extent_protocol::extentid_t id, extent_protocol::attr &a, unsigned long long tid)
{
  if (EXTENT_DEBUG)
...
int extent_server::remove(extent_protocol::extentid_t id, int &, unsigned long long tid)
{
  if (EXTENT_DEBUG)
