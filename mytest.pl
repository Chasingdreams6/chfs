...
print "Write and read one file: $f1";
writeone($dir1, $f1, 600);
checkcontent($dir1, $f1);
print "OK\n";

print "Write and read a second file: $f2";
writeone($dir1, $f2, 4111);
checkcontent($dir1, $f2);
checkcontent($dir1, $f1);
print "OK\n";

print "Overwrite an existing file: $f1";
writeone($dir1, $f1, 275); # shorter than before...
checkcontent($dir1, $f1);
checkcontent($dir1, $f2);
print "OK\n";

print "Append to an existing file: $f1";
writeone($dir1, $f1, 8192);
append($dir1, $f1, 7007);
checkcontent($dir1, $f1);
print "OK\n";

print "Write into the middle of an existing file: $f1";
writeat($dir1, $f1, 190);
checkcontent($dir1, $f1);
print "OK\n";

print "Write beyond the end of an existing file: $f1";
